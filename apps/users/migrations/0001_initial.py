# Generated by Django 2.2.4 on 2019-11-15 17:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_user_vip', models.CharField(choices=[('normal', 'Normal'), ('vip', 'VIP')], default='Normal', max_length=10, verbose_name='Vip status')),
                ('vip_validate', models.DateField(default='', null=True, verbose_name='Validate Until')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_reader', to='users.User')),
            ],
            options={
                'verbose_name': 'Reader',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_author', to='users.User')),
            ],
            options={
                'verbose_name': 'Author',
